...
@Mod(AOEItems.MODID)
public class AOEItems
{
    // Define mod id in a common place for everything to reference
    public static final String MODID = "aoe_items";
    ...
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> EXAMPLE_TAB = CREATIVE_MODE_TABS.register("example_tab", () -> CreativeModeTab.builder()
            .title(Component.translatable("itemGroup.aoe_items")) //The language key for the title of your CreativeModeTab
    ...
    public AOEItems(IEventBus modEventBus, ModContainer modContainer)
    {
    ...
    private void addCreative(BuildCreativeModeTabContentsEvent event)
    {
        if (event.getTabKey() == CreativeModeTabs.BUILDING_BLOCKS)
            event.accept(ModBlocks.COMPLETIONIST_TROPHY_BLOCK.get());
    }
